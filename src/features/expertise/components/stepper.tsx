...
export const Stepper = ({ currentStep }: { currentStep: number }) => {
  return (
    <div className="mb-10">
      <div className="relative flex items-center justify-between overflow-x-auto rounded-xl border border-gray-200 bg-white px-4 py-6 shadow-sm">
          ...
          return (
            <div key={step.id} className="relative flex flex-1 flex-col items-center text-center">
              ...
              {index < steps.length - 1 && (
                <div className="absolute top-5 right-0 z-[-1] h-1 w-full">
